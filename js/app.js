    ...
    constructor() {
        this.data = [
            ...
            },
            {
                ...
                yearStart: new Date('Octber 7, 1996'),
    ...
    buildCard(obj) {
        ...
        card.innerHTML = `
            <header class="card-header">
                <div class ="card-heading text-capitalize">${obj.title}</h2>
            </header>
            ...
            <footer class="card-footer">
                ...
                <span class="emojis" id="favorite" data-span="${obj.id}">${obj.isFavorite ? '😍' : '😒'}</span>
            </footer>
        `
...
const genreBtn = document.getElementById('networkBtn')
